...
window.I18N = {
  de: {
    ...
    lblMaxSpeed: "Höchstgeschwindigkeit (km/h)",
    lblLimit2: "Eigenes Limit (km/h)",
    speedHint: "Höchstgeschwindigkeit ist die Obergrenze zum Schnellermachen, das eigene Limit ein Deckel darunter. Mehr über das Fragezeichen.",
    speedHelp: "Zwei getrennte Dinge. Höchstgeschwindigkeit (Befehl 0x6E) setzt die absolute Obergrenze des Scooters in km/h, also wie schnell er maximal fährt, das ist der Wert zum Tunen. Eigenes Limit (Befehl 0x6B) setzt eine selbst gewählte Begrenzung unterhalb der Höchstgeschwindigkeit, gedacht damit du dich oder andere Fahrer bremst, aktiv sobald du es setzt. Beide sind unabhängig: Du kannst die Höchstgeschwindigkeit hoch stellen und trotzdem ein niedriges eigenes Limit aktiv haben. Welche Werte dein Scooter übernimmt oder ab wann er selbst abriegelt, hängt vom Modell und der Firmware ab. Probier aus was geht und lies danach den Status.",
  ...
  en: {
    ...
    s3Title: "Set speed",
    lblMaxSpeed: "Top speed (km/h)",
    lblLimit2: "Your own limit (km/h)",
    speedHint: "Top speed is the ceiling for going faster, your own limit is a cap below it. More via the question mark.",
    speedHelp: "Two separate things. Top speed (command 0x6E) sets the scooter's absolute ceiling in km/h, that is how fast it goes at most, the value for tuning. Your own limit (command 0x6B) sets a self-chosen cap below the top speed, meant to hold yourself or another rider back, active as soon as you set it. The two are independent: you can raise the top speed and still keep a low own-limit active. Which values your scooter accepts or where it caps itself depends on model and firmware. Try what works and read the status afterwards.",
