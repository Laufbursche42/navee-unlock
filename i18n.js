...
window.I18N = {
  de: {
    ...
    smTitle: "Unterstützte Modelle",
    smNote: "Aus der Firmware ermittelt (Factory-Kanal plus Region-Logik). Endgültiger Beweis ist der Test am Gerät.",
    smFull: "Unterstützt",
    smUnclear: "Unklar - am Gerät prüfen",
    smNone: "Über diesen Weg nicht",
  ...
  en: {
    ...
    smTitle: "Supported models",
    smNote: "Determined from the firmware (factory channel plus region logic). Final proof is the device test.",
    smFull: "Supported",
    smUnclear: "Unclear - check on the device",
    smNone: "Not via this method",
